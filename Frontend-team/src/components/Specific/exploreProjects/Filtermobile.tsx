...
const Filtermobile = ({ isOpen, onClose }: any) => {
  if (!isOpen) return null;
  return (
    <div className=" h-fit  border border-customBlue gap-24 rounded-[24px] mt-6 w-[713px] container mx-auto sm:hidden bg-white bg-opacity-5 max-sm:w-[400px]">
