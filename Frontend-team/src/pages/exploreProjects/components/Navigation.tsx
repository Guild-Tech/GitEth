...
const Navigation = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row mt-28 mx-2 w-full">
      {/* Navigation Bar */}
      <div className="w-full md:w-1/4 h-fit bg-[#1F253D] pt-4 pb-4 rounded-lg border border-customBorder md:mr-4 mb-4 md:mb-0">
        ...
        <h2 className="border-b border-customBorder"></h2>
          ...
          {[ 
            ...
            <button
              ...
              className={`w-full text-left px-4 py-2 rounded-lg text-white ${
                isActive === button.value ? "bg-[#293056] border border-customBorder" : ""
              }`}
              onClick={() => {
      ...
      <div className="w-full md:w-3/4 p-4 md:p-6">
        {/* "New Task" Button */}
        <button className="rmt-4 bg-white text-black px-4 py-2 mb-4 rounded-full flex items-center justify-center w-fit transition">
