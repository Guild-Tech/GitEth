...
const Tasks = () => {
  ...
  const getTasksByCategory = (category: string) => {
    ...
    return metrics.tasks.filter((task) => task.status === category);
  };
  ...
  return (
    <div className="font-sans text-white p-6 rounded-lg">
                  ...
                  getTasksByCategory(category.id).map((task) => (
                    ...
                    >
                      ...
                      <CustomBtn
                        ...
                        classname=""
                        onClick={() => handleModalOpen(category.id, task)}
                      />
                    </div>
                  ))
                )}
      ...
      {modalType === "to-do" && <AssignTaskModal isOpen onClose={closeModal} task={selectedTask} />}
