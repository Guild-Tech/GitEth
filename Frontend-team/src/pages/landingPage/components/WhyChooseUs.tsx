  ...
  return (
    <section className="mx-auto max-w-7xl px-4 py-16 ">
      <div className="max-sm:hidden grid gap-8 md:grid-cols-2 items-center relative backdrop-blur-md">
        <div className="">
          <img src={womanLaptop} alt="" className="max-w-[787px] w-full" />
        </div>
        <div className="">
          <div className=" ">
            <CustomText
              style={"text-3xl mb-8 font-bold leading-tight md:text-5xl"}
              text="Why Choose Us"
            />
            <div className="">
      ...
      <div className="flex flex-col items-center sm:hidden">
        <CustomText
          style={
            "text-3xl mb-8 font-bold leading-tight md:text-5xl max-sm:text-2xl max-sm:font-medium"
          }
          text="Why Choose Us"
        />
